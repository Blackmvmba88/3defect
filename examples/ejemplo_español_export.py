...
# Composite: Car_sports
# Nested Composite: Chassis
...
bpy.ops.mesh.primitive_cube_add(size=0.1, location=(0.0, -0.76, 0.38))
...
# Nested Composite: Engine
bpy.ops.mesh.primitive_cube_add(size=0.5, location=(1.26, 0.0, 0.6799999999999999))
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.08, depth=0.3, location=(0.81, 0.0, 1.08))
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.08, depth=0.3, location=(0.96, 0.0, 1.08))
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.08, depth=0.3, location=(1.11, 0.0, 1.08))
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.08, depth=0.3, location=(1.26, 0.0, 1.08))
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.08, depth=0.3, location=(1.41, 0.0, 1.08))
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.08, depth=0.3, location=(1.56, 0.0, 1.08))
...
# Nested Composite: Wheel_1
bpy.ops.mesh.primitive_cylinder_add(radius=0.38, depth=0.25, location=(1.26, 0.855, 0.19))
...
bpy.ops.mesh.primitive_cylinder_add(radius=0.26599999999999996, depth=0.2, location=(1.26, 0.855, 0.19))
...
# Nested Composite: Body_sports
bpy.ops.mesh.primitive_cube_add(size=1.0, location=(0.0, 0.0, 0.88))
...
bpy.ops.mesh.primitive_cube_add(size=1.0, location=(0.0, 0.0, 1.28))
